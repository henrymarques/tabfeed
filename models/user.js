...
async function update(username, userInputValues) {
  ...
  if ("email" in userInputValues) await validateUniqueEmail(userInputValues.email);

  if ("username" in userInputValues) await validateUniqueUsername(userInputValues.username);

  if ("password" in userInputValues) await hashPasswordInObject(userInputValues);
