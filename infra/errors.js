...
export class ValidationError extends Error {
  constructor({ cause, message, action }) {
    ...
    this.action = action || "Verifique as informações da solicitação e tente novamente.";
    this.statusCode = 400;
  }
...
export class NotFoundError extends Error {
  constructor({ cause, message, action }) {
    ...
    this.action = action || "Verifique sua consulta e tente novamente.";
    this.statusCode = 404;
  }
...
export class ForbiddenError extends Error {
  constructor({ cause, message, action }) {
    ...
    this.action = action || "Verifique suas permissões antes de continuar.";
    this.statusCode = 403;
  }
...
export class MethodNotAllowedError extends Error {
  constructor() {
    ...
    this.action = "Verifique sua solicitação e tente novamente.";
    this.statusCode = 405;
  }
